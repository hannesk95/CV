function [mask] = segmentation(left,right)
  ...
  features = harris_detector(I,'tile_size',50,'segment_length',3,'k',0.2,'min_dist',10,'N',10,'do_plot',false);
  % Find correspondences
  for i = 1:N
      I_n = rgb2gray(left(:,:,(1:3) + i*3));
      features_n = harris_detector(I_n,'tile_size',50,'segment_length',3,'k',0.2,'min_dist',10,'N',10,'do_plot',false);
      corr = point_correspondence(I,I_n,features,features_n,'window_length',45,'min_corr', 0.9,'do_plot',true);  
  ...
  foreground_labels = find(movement_avg > mean(movement_avg) & movement_avg < 100);
